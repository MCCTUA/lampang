...
const SENSORS = [
  ...
  },
  {
    ...
    cons: ['ผิวดำ/เปียก/เงา สะท้อนแสงกลับน้อย → ระยะตรวจสั้นลง (ผิวสว่างตรวจได้ไกลกว่าผิวดำหลายเท่า) → คอกกระบะเปล่าสีดำอาจวัดพลาด', 'อ่อนลงในฝน/หมอก/ฝุ่นจัด', 'มีชิ้นส่วนหมุน อายุการใช้งานจำกัด (อยู่ระหว่างยืนยันข้อมูลกับผู้ผลิต)'],
  },
];
