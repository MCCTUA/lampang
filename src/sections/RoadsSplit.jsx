...
export function RoadR1() {
  return (
    <RoadSlide
      ...
      Map={R1Map}
      zones={[
        { label: '① จุดวัดความสูง (ปากทาง)', file: 'R1_1_entry.png', devices: ['กล้องประเมินสูง 2 ต้น', 'เรดาร์', 'เซนเซอร์สแกน (LiDAR)', 'โคมไฟส่องสว่าง 2 ดวง', 'ลูกระนาดยาง'] },
        { label: '② ป้าย LED (จุด Sirimas ~55 ม.)', file: 'R1_2_led.png', devices: ['ป้ายแสดงผล LED', 'ตู้ควบคุม', 'Edge AI Computer', 'Network', 'MDB'] },
        { label: '③ ไม้กั้น (คอสะพานใต้)', file: 'R1_3_throat.png', devices: ['ไม้กั้น 3.3 ม.', 'กล้องบันทึกเหตุการณ์ 1 ตัว (trigger+หลักฐาน)', 'strobe + เสียงเตือน', 'ลูกระนาดยาง', 'IR', 'ตู้ควบคุมไม้กั้น'] },
      ]}
...
export function RoadR2() {
  return (
    <RoadSlide
      ...
      Map={R2Map}
      zones={[
        { label: '① จุดวัดความสูง (ปากทาง 10 ม.)', file: 'R2_1_entry.png', devices: ['กล้องประเมินสูง 2 ต้น', 'เรดาร์', 'เซนเซอร์สแกน (LiDAR)', 'โคมไฟส่องสว่าง 2 ดวง', 'ลูกระนาดยาง'] },
        { label: '② ป้าย LED (เสากลาง ~50 ม.)', file: 'R2_2_led.png', devices: ['ป้ายแสดงผล LED', 'ตู้ควบคุม', 'Edge AI Computer', 'Network', 'MDB'] },
        { label: '③ ไม้กั้น (คอสะพานเหนือ)', file: 'R2_3_throat.png', devices: ['ไม้กั้น 3.3 ม.', 'กล้องบันทึกเหตุการณ์ 1 ตัว (trigger+หลักฐาน)', 'strobe + เสียงเตือน', 'ลูกระนาดยาง', 'IR', 'ตู้ควบคุมไม้กั้น'] },
      ]}
...
export function RoadR3() {
  return (
    <RoadSlide
      ...
      Map={R3Map}
      zones={[
        { label: '① จุดวัด (3-แยกปากทาง)', file: 'R3_1_junction.png', devices: ['กล้องประเมินสูง + เรดาร์ + เซนเซอร์สแกน', '(บนเสาไฟเดิม)', 'โคมไฟส่องสว่าง', 'ลูกระนาดยาง'] },
        { label: '② ป้าย LED (ที่ 3-แยก)', file: 'R3_2_led.png', devices: ['ป้ายแสดงผล LED', 'ตู้ควบคุม + Edge AI Computer', 'MDB (กลมกลืน ไม่เสียตลาด)'] },
        { label: '③ ไม้กั้น (คอสะพานใต้)', file: 'R3_3_throat.png', devices: ['ใช้ชุดคอสะพานใต้ร่วมกับ R1', '(ไม้กั้น + กล้อง + strobe + IR จุดเดียวกัน)', 'ลูกระนาดยาง'] },
      ]}
