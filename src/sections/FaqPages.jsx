...
const ACCURACY = {
  ...
  items: [
    ...
    ['ทำไม “ยิ่งใช้ยิ่งแม่น” · เรดาร์ช่วยฝึกกล้องได้จริงไหม?', 'ได้ — เรดาร์/สแกนให้ข้อมูล (มีรถ · ระยะ · จังหวะ) ใช้เป็น “ป้ายกำกับอัตโนมัติ” (auto-label · cross-modal supervision) ป้อนฝึก AI กล้องต่อเนื่อง → ลดการ label มือ กล้องแม่นขึ้นตามการใช้งาน · เรดาร์ทำหน้าที่ตรวจจับรถเข้ามาก่อนเพื่อ “ปลุก” สแกน/กล้องเฉพาะตอนจำเป็น (ไม่ใช้เรดาร์วัดความสูงโดยตรง — ยังไม่ยืนยันความแม่น)'],
  ],
};
const SYSTEM = {
