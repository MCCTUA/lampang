...
function ReflectRange() {
  const rows = [
    ['ผิวสว่าง (สะท้อน ~90%)', 25, 520, '#E7F0E9', G],
    ['ผิวทั่วไป (สะท้อน ~10%)', 15, 312, 'var(--h-gold-soft)', '#8A5A12'],
    ['ผิวดำมาก (สะท้อน ~2%)', 7, 145, 'var(--h-red-soft)', RED],
  ];
  return (
  ...
  return (
    <Section id="lidar" tone="soft">
      ...
      <FadeUp>
        ...
        <ReflectRange />
        <Note className="mt-3">
          ระยะที่ตรวจได้ขึ้นกับการสะท้อนของผิววัตถุ — ผิวสว่างตรวจได้ไกล ผิวดำมากสะท้อนแสงกลับน้อย ระยะสั้นลงชัดเจน · นี่คือเหตุผลเชิงฟิสิกส์ของปัญหา “คอกกระบะเปล่าสีดำ” และทำไมต้องมีเรดาร์/กล้องช่วยชดเชย
        </Note>
      </FadeUp>
      ...
      <FadeUp delay={0.05}>
        <Card accent="gold" className="mt-6">
          ...
          <ul className="list-disc pl-5 text-[14px] space-y-1.5">
            ...
            <li><strong>ตัวเซนเซอร์ออกแบบสำหรับงานในอาคาร</strong> → ใช้กลางแจ้งต้องมี <strong>ตู้/ครอบกันแดดฝน + กันไอน้ำควบแน่น</strong> · เลี่ยงอุณหภูมิแกว่งรุนแรง · ไม่ใช้ในบรรยากาศไวไฟ/กัดกร่อน</li>
          </ul>
          <Note className="mt-2">
